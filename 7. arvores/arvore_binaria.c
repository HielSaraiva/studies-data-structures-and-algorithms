...
// inserção
// tem 2 casos a avaliar
// 1o - quando o nó é nulo
// 2o - quando não é nulo
// versão com retorno do nó
...
// 1o - nós sem filhos (ou seja, folhas)
// 2o - nós com apenas um filho
// 3o - nós com dois filhos
noa *a_remover(noa *raiz, int valor)
{
   ...
   // se chegou até aqui então é porque achou o nó a a_remover
   // temos 3 casos de remoção
